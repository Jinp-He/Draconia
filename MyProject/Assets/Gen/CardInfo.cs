...
public sealed partial class CardInfo :  Bright.Config.BeanBase 
{
    ...
    public CardInfo(int id, string Name, string Desc, int Cost, Rarity Rarity, SkillTarget SkillTargetType, string BelongedCharacter, System.Collections.Generic.List<EnumCardProperty> Properties ) 
    {
        this.Id = id;
        this.Name = Name;
        this.Desc = Desc;
