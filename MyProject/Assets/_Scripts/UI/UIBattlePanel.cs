...
namespace Draconia.UI
{
	...
	public partial class UIBattlePanel : UIPanel, ICanSendEvent, ICanGetSystem
	{
		...
		protected override void OnInit(IUIData uiData = null)
		{
			...
			{
				Debug.Log("#DEBUG# Init Battle System: " + player.Alias);
			...
			battleSystem.Players = Characters;
			...
			Debug.Log("#BattleSystem# EndInitialization");
			Hands.OnInit(Characters);
			battleSystem.Hands = Hands;
			Debug.Log("#BattleSystem# EndInitialization");
